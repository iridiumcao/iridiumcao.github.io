...
Bash is one of the many shells in Linux, but it is the most widely used. Almost all distributions include it by default, and it is even present in Android.  
The content recorded here does not cover all aspects of Bash; it serves only as a reference for daily use. For more detailed information, see the [official Bash manual](http://www.gnu.org/software/bash/manual/bashref.html).
