...
3. [素数判定](prime/prime.md)
4. [求平方根——牛顿迭代法](sqrt/sqrt.md)
5. [交换两数](exchange-two-values.md)
...
1. [冒泡排序](bubble-sort/content.md)
2. [选择排序](selection-sort/content.md)
3. [快速排序](quick-sort/content.md)